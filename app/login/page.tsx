      ...
      <div className="container mx-auto px-6 py-20 max-w-md">
        <Card className="border-gray-200 shadow-sm">
          <CardHeader className="text-center pb-8">
            ...
            <p className="text-gray-600 font-light">Sign in to your Medici account</p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <Button asChild size="lg" className="w-full rounded-full bg-blue-600 hover:bg-blue-700 h-12">
              <Link href="/dashboard">
                Sign In
            ...
            <div className="space-y-3">
              <Button variant="outline" className="w-full rounded-full border-gray-300 h-12">
